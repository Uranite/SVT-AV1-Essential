...
static EbErrorType set_cfg_recon_file(EbConfig *cfg, const char *token, const char *value) {
    printf("Svt[info]: You have enabled output recon. If you intended to set the output path,\n");
    printf("Svt[info]: the right parameter is --output or -b.\n");
...
ConfigDescription config_entry_options[] = {
    ...
    {PROGRESS_TOKEN,
     "Verbosity of the output, default is 2 [0: no progress is printed, 1: basic progress, 2: detailed progress]"},
    {HIDE_BANNER_TOKEN,
...
ConfigDescription fconfig_entry_options[] = {
    ...
    {PROGRESS_TOKEN, "Verbosity of the output, default is 2 [0: no progress is printed, 1: basic progress, 2: detailed progress]"},
    {NO_PROGRESS_TOKEN,
...
ConfigDescription fconfig_entry_rc[] = {
    ...
    {CRF_LONG_TOKEN,
     ...
     "x`.  Compared to `--qp`, `--crf` can take a value up to 70, and can be set in 0.25 increments, default is 30 "
     "[1-70]"},
...
uint32_t get_fhelp(int32_t argc, char *const argv[]) {
    ...
    print_options("Psychovisual Options", fconfig_entry_psychovisual);
