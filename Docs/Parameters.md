...
| **MbrOverShootPct**              | --mbr-overshoot-pct              | [0-100]    | 0           | Allowable datarate overshoot (max) target (%), Only applicable for Capped CRF                                                                        |
...
| **MinChromaQmLevel**             | --chroma-qm-min                  | [0-15]     | 4           | Min chroma quant matrix flatness                                                                                                                     |
...
| **KFTemporalFilteringStrength**  | --kf-tf-strength                 | [0-4]      | 0           | Manually adjust temporal filtering strengh on keyframes. Higher values = stronger temporal filtering                                                 |
...
| **Configuration file parameter** | **Command line**      | **Range**       | **Default**       | **Description**                                                                                                                                              |
|----------------------------------|-----------------------|-----------------|-------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Keyint**                       | --keyint              | [-2-`(2^31)-1`] | -2                | Max GOP size (frames), use `s` suffix for seconds (SvtAv1EncApp only) [-2: ~5 seconds, -1: "infinite" only for CRF, 0: == -1]                                |
...
| **LoopFilterEnable**             | --enable-dlf           | [0-3]          | 2           | Deblocking loop filter control (1: enabled, 2: slower, more accurate filtering, 3: maximum accuracy)                                                                  |
